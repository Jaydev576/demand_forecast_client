...
export function Upload() {
  ...
  { field: 'discount', type: 'Number', required: true, example: '5000' },
  { field: 'final_price', type: 'Number', required: true, example: '74999' },
  { field: 'competitor_price', type: 'Number', required: true, example: '77000' },
  { field: 'marketing_spend', type: 'Number', required: true, example: '150000' },
